...
+ (KeypadButton *)numberButtonWithValue:(NSInteger)value andSubtitle:(NSString *)subtitle {
    ...
    if (subtitle != nil) {
        keypadButton.secondaryLabel.font = [keypadButton.secondaryLabel.font fontWithSize:12];
    }

    keypadButton.borderHidden = NO;
    keypadButton.textColor = [UIColor systemGrayColor];
    keypadButton.highlightTextColor = [UIColor systemBackgroundColor];
    keypadButton.borderColor = [UIColor systemGrayColor];
    keypadButton.highlightBackgroundColor = [UIColor systemTealColor];
...
+ (KeypadButton *)systemButtonWithTitle:(NSString *)title {
    ...
    keypadButton.textColor = [UIColor systemGrayColor];
    keypadButton.highlightTextColor = [UIColor systemTealColor];
...
- (void)layoutSubviews {
    ...
    if (_secondaryLabel == nil) {
        ...
        _secondaryLabel.frame = CGRectMake(0, _mainLabel.frame.origin.y + _mainLabel.frame.size.height + 3, w, _secondaryLabel.bounds.size.height);
    }
}
...
- (void)setTextColor:(UIColor *)textColor {
    ...
    if (_secondaryLabel != nil) {
        _secondaryLabel.textColor = textColor;
    }
}
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if (_secondaryLabel != nil) {
        _secondaryLabel.textColor = _highlightTextColor;
    }
}
...
- (void)clearHighlight {
    ...
    if (_secondaryLabel != nil) {
        _secondaryLabel.textColor = _textColor;
    }
}
